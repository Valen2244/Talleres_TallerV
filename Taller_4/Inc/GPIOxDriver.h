...
// Incluyendo este archivo estamos invluyendo también el correspondiente al GPIOx
...
void GPIOxTooglePin(GPIO_Handler_t *pPinHandler);		// Prototipo o cabecera de la función.
